    ...
    <div class="navbar navbar-default mega-menu" role="navigation">
        <div class="container">
            ...
            <a href="{{route('cart.index')}}"><i class="fa fa-shopping-cart"></i></a>
                <span class="badge badge-sea rounded-x">{{Cart::count()}}</span>
                <div class="badge-open">
                    <ul class="list-unstyled mCustomScrollbar" data-mcs-theme="minimal-dark">
                        @foreach(Cart::content() as $item)
                        <li>
                            <img src="{{ asset('assets/img/products/'.$item->model->slug.'.webp')}}" alt="">
                            <button type="button" class="close">×</button>
                            <div class="overflow-h">
                                <span>{{$item->model->name}}</span>
                            <small>{{$item->model->price}}</small>
                            </div>
                        </li>
                        @endforeach
                    </ul>
                    <div class="subtotal">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                            <a href="{{route('cart.index')}}"  class="btn-u btn-brd btn-brd-hover btn-u-sea-shop btn-block">View Cart</a>
                            </div>
                            <div class="col-xs-6">
